...
const PremiumScheme = new mongoose_1.Schema({
...
PremiumScheme.methods.getData = function (ratioCurrency, currency) {
    return {
        id: this._id,
        name: this.name,
...
const PremiumModel = (0, mongoose_1.model)("Premium", PremiumScheme);
exports.default = PremiumModel;
